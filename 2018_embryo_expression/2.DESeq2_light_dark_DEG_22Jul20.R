...
#I had already created a count matrix using a perl script have the following columns: GENE SAMPLE_1 SAMPLE_2 ....
#I re-organized in excel and created below file 

#Read in the data
filename <- "../../raw/light_dark_rna_fpkms_CPM_DEG_18june19_count.csv" #file containing the read count matrix
...
vsd <- rlog(dds) #have to use rlog to normalize sequencing data vst wont normalize for sequencing depth
...
write.csv(norm.counts, file = "count_matrix_RLOG.csv", quote = F)
...
library("ggplot2")
library("ggrepel")
pcaData <- plotPCA(vsd,intgroup=c("genotype", "treatment"))
...
dds.res.B73_light <- lfcShrink(dds, contrast=c("geno_trt", "B73_light", "B73_control"), dds.res.B73_light=dds.res.B73_light,type='normal')
dds.res.B73_dark <- lfcShrink(dds, contrast=c("geno_trt", "B73_dark", "B73_control"), dds.res.B73_dark=dds.res.B73_dark,type='normal')
dds.res.B73_dl <- lfcShrink(dds, contrast=c("geno_trt", "B73_dark", "B73_light"), dds.res.B73_dl=dds.res.B73_dl,type='normal')
dds.res.OH7B_light <- lfcShrink(dds, contrast=c("geno_trt", "OH7B_light", "OH7B_control"), dds.res.OH7B_light=dds.res.OH7B_light,type='normal')
dds.res.OH7B_dark <- lfcShrink(dds, contrast=c("geno_trt", "OH7B_dark", "OH7B_control"), dds.res.OH7B_dark=dds.res.OH7B_dark,type='normal')
dds.res.OH7B_dl <- lfcShrink(dds, contrast=c("geno_trt", "OH7B_dark", "OH7B_light"), dds.res.OH7B_dl=dds.res.OH7B_dl,type='normal')
dds.res.M37W_light <- lfcShrink(dds, contrast=c("geno_trt", "M37W_light", "M37W_control"), dds.res.M37W_light=dds.res.M37W_light,type='normal')
dds.res.M37W_dark <- lfcShrink(dds, contrast=c("geno_trt", "M37W_dark", "M37W_control"), dds.res.M37W_dark=dds.res.M37W_dark,type='normal')
dds.res.M37W_dl <- lfcShrink(dds, contrast=c("geno_trt", "M37W_dark", "M37W_light"), dds.res.M37W_dl=dds.res.M37W_dl,type='normal')
dds.res.MS71_light <- lfcShrink(dds, contrast=c("geno_trt", "MS71_light", "MS71_control"), dds.res.MS71_light=dds.res.MS71_light,type='normal')
dds.res.MS71_dark <- lfcShrink(dds, contrast=c("geno_trt", "MS71_dark", "MS71_control"), dds.res.MS71_dark=dds.res.MS71_dark,type='normal')
dds.res.MS71_dl <- lfcShrink(dds, contrast=c("geno_trt", "MS71_dark", "MS71_light"), dds.res.MS71_dl=dds.res.MS71_dl,type='normal')
dds.res.b97_light <- lfcShrink(dds, contrast=c("geno_trt", "b97_light", "b97_control"), dds.res.b97_light=dds.res.b97_light,type='normal')
dds.res.b97_dark <- lfcShrink(dds, contrast=c("geno_trt", "b97_dark", "b97_control"), dds.res.b97_dark=dds.res.b97_dark,type='normal')
dds.res.b97_dl <- lfcShrink(dds, contrast=c("geno_trt", "b97_dark", "b97_light"), dds.res.b97_dl=dds.res.b97_dl,type='normal')
dds.res.Ki11_light <- lfcShrink(dds, contrast=c("geno_trt", "Ki11_light", "Ki11_control"), dds.res.Ki11_light=dds.res.Ki11_light,type='normal')
dds.res.Ki11_dark <- lfcShrink(dds, contrast=c("geno_trt", "Ki11_dark", "Ki11_control"), dds.res.Ki11_dark=dds.res.Ki11_dark,type='normal')
dds.res.Ki11_dl <- lfcShrink(dds, contrast=c("geno_trt", "Ki11_dark", "Ki11_light"), dds.res.Ki11_dl=dds.res.Ki11_dl,type='normal')
dds.res.NC358_light <- lfcShrink(dds, contrast=c("geno_trt", "NC358_light", "NC358_control"), dds.res.NC358_light=dds.res.NC358_light,type='normal')
dds.res.NC358_dark <- lfcShrink(dds, contrast=c("geno_trt", "NC358_dark", "NC358_control"), dds.res.NC358_dark=dds.res.NC358_dark,type='normal')
dds.res.NC358_dl <- lfcShrink(dds, contrast=c("geno_trt", "NC358_dark", "NC358_light"), dds.res.NC358_dl=dds.res.NC358_dl,type='normal')
...
dds.filter <- function(x) {
  x <- x[!is.na(x$padj), ]
  y <- x[((x$padj < 0.05) & (abs(x$log2FoldChange) > 2)), ]
  return(y)
}
...
#write results to a file for later use and further analysis 
write.csv(dds.res.flt$`B73_light`, file = "B73_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`B73_dark`, file = "B73_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`B73_dl`, file = "B73_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`OH7B_light`, file = "OH7B_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`OH7B_dark`, file = "OH7B_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`OH7B_dl`, file = "OH7B_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`M37W_light`, file = "M37W_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`M37W_dark`, file = "M37W_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`M37W_dl`, file = "M37W_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`MS71_light`, file = "MS71_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`MS71_dark`, file = "MS71_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`MS71_dl`, file = "MS71_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`b97_light`, file = "B97_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`b97_dark`, file = "B97_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`b97_dl`, file = "B97_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`Ki11_light`, file = "Ki11_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`Ki11_dark`, file = "Ki11_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`Ki11_dl`, file = "Ki11_dark_vs_light_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`NC358_light`, file = "NC358_light_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`NC358_dark`, file = "NC358_dark_vs_control_deseq2_res.csv", quote = F)
write.csv(dds.res.flt$`NC358_dl`, file = "NC358_dark_vs_light_deseq2_res.csv", quote = F)

writeLines(capture.output(sessionInfo()), "22Jul20_session_info_light_dark_DESeq2.txt") #writes session info to a file for version information later 
...
write.csv(dds.res$`B73_dark`, file = "B73_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`OH7B_dark`, file = "OH7B_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`M37W_dark`, file = "M37W_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`MS71_dark`, file = "MS71_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`b97_dark`, file = "B97_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`Ki11_dark`, file = "Ki11_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
write.csv(dds.res$`NC358_dark`, file = "NC358_dark_vs_light_deseq2_res_ALL.csv", quote = F)
...
#gene info
gene_info=read.csv('~/Desktop/curated_gene_list_v43_gene.csv')
all_res_merged=merge(gene_info,all_res,by.x='gene_ID',by.y='gene',all.y=T)
write.csv(all_res_merged,"all_sig_DEG_deseq2_res.csv", quote = F,row.names = F)
