...
Each code chunk is basically the same except for different tissue types and differ by formatting issues.

I suggest only reading the first code chunk to understand how we did the analysis

```{r 2018 embryo metabolites}

#input data.frame (replace location with where the file is located)
metabolite <- read.xlsx("../data/figure2_data.xlsx",1)
...
write.csv(blues, "../data/embryo_2018_BLUEs.csv")
...
metabolite <- read.csv("../data/figureS2.csv")
setwd("2018_mature")
...
metabolite <- read.csv("../data/figureS3.csv")
...
write.csv(blues, "../data/mature_2019_BLUEs.csv")
