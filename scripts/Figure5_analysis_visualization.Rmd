...
re <-  read_xlsx("../data/20GH-POR TOCOS and CAROTS data.xlsx", sheet = 2)[,-c(2,7:9)]
...
```{r Figure 5b}
#code is mostly the same so follow comments from code chunk Figure 5a

#Plot metabolites from 2019 GH experiment
metabolites <- read.csv("../data/2019_Cornell_field_2f_53_samples.csv")
